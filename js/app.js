...
const carriers = [
  {
    ...
    text4: "Все размеры на макете указаны в миллиметрах."
  },
  {
  ...
  },
  {
    ...
    text4: "Все размеры на макете указаны в пикселях.",
  ...
  {
    name: "Веб-сайт",
    type: "Цифровой носитель",
    img: "assets/images/Веб-сайт.png",
    layout: "assets/images/21 Веб-сайт макет.png",
    desc: "Веб-сайт является основным продуктом бренда. На веб-сайте пользователь может купить абонемент, записаться на групповую тренировку, отправить свой вопрос или заявкку через форму обратной связи.",
    text1: "В реализации веб-сайта следует учитывать цветовую палитру и шрифты, используемые брендом.",
    text2: "Размер веб-сайта зависит от устройства и легко адаптируется.",
    text3: "Сетка состоит из 12 колоном размером 118 px, расстояние между колонками – 16 px, расстояние от сетки до края – 160 px",
    size: "Размер носителя: 1920 px x 1080 px",
    text4: "Все размеры на макете указаны в пикселях."
  }
];
...
const modalText4 = document.querySelector("#modalText4");
...
function openCarrierModal(item) {
  ...
  modalText4.textContent = item.text4;
